...
mysql -u root -e "CREATE DATABASE sportcard101 CHARACTER SET utf8mb4;"
...
### Deploying to a subdomain (e.g. sportcard101.com on shared hosting)
...
1. Upload everything in this repo into the subdomain's document root folder
   (the folder hPanel created for `sportcard101.com`).
...
```cron
*/15 * * * *  php /path/to/sportcard101/bin/scan.php >> /var/log/sportcard101.log 2>&1
```
